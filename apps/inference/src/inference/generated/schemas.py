...
class SmoothGateCfg(BaseModel):
    ...
    modelDisagreementCommitConfidence: Annotated[float, Field(ge=0.0, le=1.0)]
    ...
    dominantCommitConfidence: Annotated[float, Field(ge=0.0, le=1.0)]
    dominantCommitCount: Annotated[int, Field(ge=0)]
    dominantCommitMinChars: Annotated[int, Field(ge=0)]
